...
var ConnectionMetadataBuilder = /** @class */ (function () {
    ...
    ConnectionMetadataBuilder.prototype.buildMigrations = function (migrations) {
        ...
        var allMigrationClasses = tslib_1.__spread(migrationClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(this.connection.logger, migrationDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildSubscribers = function (subscribers) {
        ...
        var allSubscriberClasses = tslib_1.__spread(subscriberClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(this.connection.logger, subscriberDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildEntityMetadatas = function (entities) {
        ...
        var allEntityClasses = tslib_1.__spread(entityClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(this.connection.logger, entityDirectories));
