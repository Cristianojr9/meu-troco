...
var RawSqlResultsToEntityTransformer = /** @class */ (function () {
    ...
    RawSqlResultsToEntityTransformer.prototype.group = function (rawResults, alias) {
        ...
        if (alias.metadata.tableType === "view") {
            keys.push.apply(keys, __spread(alias.metadata.columns.map(function (column) { return DriverUtils.buildColumnAlias(_this.driver, alias.name, column.databaseName); })));
        }
        else {
            keys.push.apply(keys, __spread(alias.metadata.primaryColumns.map(function (column) { return DriverUtils.buildColumnAlias(_this.driver, alias.name, column.databaseName); })));
        }
