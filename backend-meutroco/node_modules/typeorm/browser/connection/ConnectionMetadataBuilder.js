...
var ConnectionMetadataBuilder = /** @class */ (function () {
    ...
    ConnectionMetadataBuilder.prototype.buildMigrations = function (migrations) {
        ...
        var allMigrationClasses = __spread(migrationClasses, importClassesFromDirectories(this.connection.logger, migrationDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildSubscribers = function (subscribers) {
        ...
        var allSubscriberClasses = __spread(subscriberClasses, importClassesFromDirectories(this.connection.logger, subscriberDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildEntityMetadatas = function (entities) {
        ...
        var allEntityClasses = __spread(entityClasses, importClassesFromDirectories(this.connection.logger, entityDirectories));
